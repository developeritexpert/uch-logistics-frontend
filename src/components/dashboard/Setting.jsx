...
function Setting() {
  ...
  const EyeIcon = ({ show }) => (
    show ? (
      <svg className="w-[15px]" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div>
      <div className="w-full rounded-[15px] border border-[#22358114] bg-white px-[15px] py-[20px] sm:px-[20px] sm:py-[25px] lg:py-[35px] lg:px-[30px] mb-[30px]">
        <div className="flex flex-wrap sm:flex-nowrap items-center gap-[30px]">
          <div className="relative w-[80px] h-[80px] md:w-[100px] md:h-[100px] lg:w-[120px] lg:h-[120px] rounded-full">
            ...
            <span className="cursor-pointer flex items-center justify-center rounded-full bg-primary absolute bottom-0 right-0 border-2 border-white h-[30px] w-[30px] md:h-[36px] md:w-[36px]">
              <svg
          ...
          <div>
            ...
            <p className="text-[16px] md:text-[18px] font-medium text-primary">
              Admin
            </p>
          </div>
        </div>
      ...
      <div className="w-full rounded-[15px] border border-[#22358114] bg-white mb-[30px]">
        <div className="flex flex-wrap sm:flex-nowrap gap-[20px] items-center justify-between px-[15px] py-[20px] sm:px-[20px] sm:py-[25px] lg:pl-[30px] lg:pr-[60px] lg:py-[20px] border-b border-[#22358114]">
          <h2 className="text-[18px] md:text-[22px] lg:text-[25px] font-bold">
          ...
          {isEditing ? (
            <div className="flex gap-3">
              ...
              <button 
                ...
                className="min-w-[100px] cursor-pointer rounded-[6px] bg-primary border border-primary px-[25px] py-[10px] text-sm font-semibold text-white hover:bg-primary/20 hover:text-primary duration-300 transition"
              >
                Save
              </button>
            </div>
            ...
            <button 
              ...
              className="group flex items-center gap-2 rounded-md bg-secondary border border-secondary hover:bg-secondary/20 hover:text-secondary duration-300 px-[25px] py-[10px] min-w-[100px] text-sm text-white transition"
            >
        ...
        <div className="grid grid-cols-1 gap-[20px] px-[15px] py-[20px] sm:px-[20px] sm:py-[25px] lg:px-[38px] lg:py-[30px] sm:grid-cols-2 md:grid-cols-3">
          <div>
            <p className="text-sm text-[#515151] mb-1">First Name</p>
            {isEditing ? (
              <input
                type="text"
                name="firstName"
                ...
                className="w-full rounded-md border border-[#22358114] px-4 py-2 text-sm focus:border-[#515151] duration-300 focus:outline-none"
              />
            ) : (
              <p className="font-semibold text-black">{personalInfo.firstName}</p>
            )}
          </div>

          <div>
            <p className="text-sm text-[#515151] mb-1">Last Name</p>
            {isEditing ? (
              <input
                type="text"
                name="lastName"
              ...
              <p className="font-semibold text-black">{personalInfo.lastName}</p>
            )}
          </div>

          <div>
            <p className="text-sm text-[#515151] mb-1">Email Address</p>
            {isEditing ? (
              <input
                type="email"
                name="email"
              ...
              <p className="font-semibold text-black">{personalInfo.email}</p>
            )}
          </div>

          <div>
            <p className="text-sm text-[#515151] mb-1">Phone Number</p>
            {isEditing ? (
              <input
                type="tel"
                name="phone"
              ...
              <p className="font-semibold text-black">{personalInfo.phone}</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="w-full rounded-[15px] border border-[#22358114] bg-white">
        <div className="flex gap-[20px] flex-wrap sm:flex-nowrap items-center justify-between px-[15px] py-[20px] sm:px-[20px] sm:py-[25px] lg:pl-[30px] lg:pr-[60px] lg:py-[20px] border-b border-[#22358114]">
          <h2 className="text-[18px] md:text-[22px] lg:text-[25px] font-semibold text-black">
            Password
          </h2>
        ...
        <div className="grid grid-cols-1 gap-6 px-[15px] py-[20px] sm:px-[20px] sm:py-[25px] lg:px-[38px] lg:py-[30px] sm:grid-cols-2 md:grid-cols-3">
          <div>
            <label className="mb-2 block text-sm text-[#515151]">
              Current Password
            </label>
            <div className="relative">
              <input
                ...
                placeholder="********"
                className="w-full rounded-[5px] border border-[#22358114] px-4 py-2 text-sm focus:border-[#515151] duration-300 focus:outline-none"
              />
              <button
