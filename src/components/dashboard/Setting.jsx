    ...
    <div>
      <div className="w-full rounded-[15px] border border-[#22358114] bg-white px-[15px] py-[20px] sm:px-[20px] sm:py-[25px] lg:py-[35px] lg:px-[30px] mb-[30px]">
        <div className="flex flex-wrap sm:flex-nowrap items-center gap-[30px]">
          <div className="relative w-[80px] h-[80px] md:w-[100px] md:h-[100px] lg:w-[120px] lg:h-[120px] rounded-full">
            ...
            <span className="flex items-center justify-center rounded-full bg-primary absolute bottom-0 right-0 border-2 border-white h-[30px] w-[30px] md:h-[36px] md:w-[36px]">
              <svg
      ...
      <div className="w-full rounded-[15px] border border-[#22358114] bg-white mb-[30px]">
        <div className="flex flex-wrap sm:flex-nowrap gap-[20px] items-center justify-between px-[15px] py-[20px] sm:px-[20px] sm:py-[25px] lg:pl-[30px] lg:pr-[60px] lg:py-[20px] border-b border-[#22358114]">
          <h2 className="text-[18px] md:text-[24px] lg:text-[28px] font-bold">
          ...
          {isEditing ? (
            <div className="flex gap-3">
              <button 
                ...
                className="rounded-md border border-[#22358114] px-[20px] py-[11px] text-sm text-gray-600 hover:bg-gray-50 transition"
              >
                Cancel
              </button>
              <button 
                onClick={handleSavePersonalInfo}
                className="flex items-center gap-2 rounded-md bg-[#223581] px-[20px] py-[11px] text-sm text-white hover:bg-[#1b2e6d] transition"
              >
                Save Changes
              </button>
            </div>
            ...
            <button 
              ...
              className="flex items-center gap-2 rounded-md bg-secondary px-[20px] py-[11px] text-sm text-white transition hover:bg-opacity-90"
            >
        ...
        <div className="grid grid-cols-1 gap-y-6 px-[15px] py-[20px] sm:px-[20px] sm:py-[25px] lg:px-[38px] lg:py-[30px] sm:grid-cols-2 md:grid-cols-3">
          <div>
            ...
            {isEditing ? (
              <input
                ...
                className="w-full rounded-md border border-[#22358114] px-4 py-2 text-sm focus:border-[#515151] focus:outline-none"
              />
            ) : (
              <p className="font-medium text-black">{personalInfo.firstName}</p>
            )}
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="font-medium text-black">{personalInfo.lastName}</p>
            )}
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="font-medium text-black">{personalInfo.email}</p>
            )}
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="font-medium text-black">{personalInfo.phone}</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="w-full rounded-[15px] border border-[#22358114] bg-white">
        <div className="flex gap-[20px] flex-wrap sm:flex-nowrap items-center justify-between px-[15px] py-[20px] sm:px-[20px] sm:py-[25px] lg:pl-[30px] lg:pr-[60px] lg:py-[20px] border-b border-[#22358114]">
          <h2 className="text-[18px] md:text-[24px] lg:text-[28px] font-semibold text-black">
            Password
          </h2>

          <div className="flex gap-3 items-center">
            <button className="rounded-md border border-[#22358114] hover:border-[#515151] duration-300 px-[25px] py-[12px] text-sm text-[#515151] font-semibold transition">
              Cancel
            </button>
            <button className="rounded-md bg-[#223581] px-[25px] py-[12px] text-sm font-semibold text-white hover:bg-[#1b2e6d] transition">
              Save
            </button>
          </div>
        </div>
