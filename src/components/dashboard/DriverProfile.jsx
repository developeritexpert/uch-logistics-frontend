    ...
    <section className="p-0 md:p-6">
      <div className="flex flex-wrap sm:flex-nowrap items-center gap-[30px] justify-between mb-6">
        ...
        <div className="flex gap-4">
          <Link
            href="/add-new-driver"
            className="group flex items-center gap-[5px] bg-secondary border border-secondary hover:bg-secondary/20 min-w-[100px] hover:text-secondary duration-300 cursor-pointer rounded-[7px] px-[25px] py-[10px] text-sm text-white hover:bg-opacity-90 transition-colors"
          >
            <svg
                    ...
                    <tr key={driver.id} className="bg-white">
                      <td className="px-[20px] py-[20px] border-y border-[#22358114] border-l rounded-l-[15px] w-[100px]">
                        {/* <label className="group cursor-pointer select-none">
                          ...
                          >
                            <svg
                              className="w-3 lg:w-4 lg:h-4 opacity-0 transition group-has-[:checked]:opacity-100"
                              viewBox="0 0 12 10"
                              fill="none"
                            >
                              <path
