            ...
            <section className="p-0 sm:p-6">
                ...
                <div className="flex flex-wrap  xl:flex-nowrap items-center justify-between  gap-[40px] mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        <button className=" gap-2 rounded-md bg-[#C00000] py-[16px] px-[21px] h-[48px] lg:h-[53px] leading-normal text-[16px] md:text-[18px] font-bold text-white hover:bg-opacity-90 transition">
