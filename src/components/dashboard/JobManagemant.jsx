        ...
        <div>
            <section className="p-0 sm:p-6">
                ...
                <div className="flex flex-wrap  xl:flex-nowrap items-center justify-between  gap-[40px] mb-6">
                    ...
                    <div className="flex  flex-col items-start sm:flex-row sm:items-center  flex-wrap lg:flex-nowrap gap-[20px] w-full xl:w-[70%]">
                        ...
                        <div className='flex w-full sm:w-[fit-content] flex-col sm:flex-row  items-center gap-[15px]'>
                            <div className="relative w-full ]">
                                <input
                                    type="date"
                                    className="h-[48px] lg:h-[53px] w-full sm:w-[155px] rounded-[6px] border  border-[#22358114] px-[13px] text-[#B4B4B4] text-[16px] font-normal "
                                />
                            </div>
                            ...
                            <div className="relative  w-full sm:w-[155px] rounded-[6px] border border-[#22358114]">
                                <input
                                    type="date"
                                    className="h-[48px] lg:h-[53px] w-full  px-[13px] text-[#B4B4B4] text-[16px] "
                                />
                            </div>
                        </div>
                        ...
                        <div className="relative  w-full max-w-[624px] ">
                            <input
                                ...
                                className="h-[48px] lg:h-[53px] w-full rounded-md border  border-[#22358114] px-[13px] text-[#B4B4B4] text-[16px] font-normal   "
                            />
                            <svg
                    ...
                    <div className="flex flex-wrap sm:flex-nowrap items-center sm:justify-end gap-3 xl:w-[25%]">


                        <button className="flex items-center gap-2 rounded-md bg-[#1E3A8A] px-4 h-[48px] lg:h-[53px] text-[16px] md:text-[18px] font-bold leading-normal text-white hover:bg-opacity-90 transition">
                        ...
                        <button className="flex items-center gap-2 rounded-md bg-[#DC2626] px-4 h-[48px] lg:h-[53px] text-[16px] md:text-[18px] font-bold leading-normal text-white hover:bg-opacity-90 transition">
