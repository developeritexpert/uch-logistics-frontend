            ...
            <section className="">
                ...
                <div className="flex flex-wrap  xl:flex-nowrap items-center justify-between gap-[20px] mb-6">
                    ...
                    <div className="flex  flex-col items-start sm:flex-row sm:items-center  flex-wrap xl:flex-nowrap gap-[20px] w-full xl:w-[70%]">
                        ...
                        <div className="relative  w-full lg:max-w-[200px] 2xl:min-w-[624px] ">
                            <input
                                type="text"
                    ...
                    <div className=" w-full flex flex-wrap xl:flex-nowrap items-center xl:justify-end gap-3 xl:w-[30%]">
                        ...
                        <button className="whitespace-nowrap group flex justify-center items-center gap-[5px] rounded-[6px] bg-primary border border-primary hover:bg-primary/20 hover:text-primary duration:300 w-full sm:w-[fit-content]  px-[25px] 2xl:py-[12px] py-[10px] min-w-[100px] 2xl:text-[18px] text-sm font-semibold leading-normal text-white cursor-pointer transition">
                            <svg className='w-[15px] h-[15px]' width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button className="whitespace-nowrap group flex justify-center items-center gap-[5px] rounded-[6px] bg-secondary border border-secondary hover:text-secondary hover:bg-secondary/20 duration-300 cursor-pointer w-full sm:w-[fit-content] min-w-[100px] px-[25px] 2xl:py-[12px] py-[10px]  2xl:text-[18px] text-sm font-semibold leading-normal text-white transition">
                ...
                <div className="flex items-center justify-center mt-8">
                    <div className="flex gap-2">
                        <button className="group px-3 border border-[#22358114] w-[50px] h-[50px] hover:border-secondary hover:bg-secondary text-[#515151] hover:text-primary rounded-[50%] text-sm duration-300 flex items-center justify-center">
                        ...
                        <button className=" border border-[#22358114] w-[50px] h-[50px] hover:border-primary text-[#515151] hover:text-primary rounded-[50%] text-sm duration-300">
                            1
                        </button>
                        <button className="border border-[#22358114] w-[50px] h-[50px] hover:border-primary text-[#515151] hover:text-primary rounded-[50%] text-sm duration-300">
                            2
