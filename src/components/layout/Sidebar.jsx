...
function Sidebar({ collapsed, setCollapsed }) {
    ...
    return (
        <aside className={`${collapsed ? 'w-[80px]' : 'w-[250px]'} bg-primary h-screen duration-300 overflow-hidden`}>
            <div className={`${collapsed ? 'px-[10px]' : 'px-[30px]'} duration-300 py-[5px] h-[80px] flex items-center justify-center border-b mx-[10px] border-[#FFFFFF33]`}>
                <Image
                    src="/img/logo.png"
                    alt="Logo"
                    width={300}
                    height={300}
                    className={`${collapsed ? 'w-[50px]' : 'w-[120px]'} duration-300`}
                />
            </div>
            <div className={`${collapsed ? 'pl-[10px]' : 'pl-[20px]'} py-[50px] h-[calc(100vh-180px)] duration-300`}>
                <nav className='space-y-[10px]'>
                    ...
                    {/* <Link href="/dashboard" className={` ${collapsed ? 'gap-[20px]' : 'gap-[10px]' } duration-300 text-white flex items-center whitespace-nowrap group hover:bg-[#C00000] rounded-l-[170px] p-[10px] pr-[20px] duration-300`}>
                        <span className='border border-[#FFFFFF] p-[10px] rounded-full group-hover:bg-white duration-300'>
                            <svg className='w-[15px] h-[15px]' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path 
                    ...
                    {/* <Link href="/job-management" className={` ${collapsed ? 'gap-[20px]' : 'gap-[10px]'} duration-300 text-white flex items-center whitespace-nowrap group hover:bg-[#C00000] rounded-l-[170px] p-[10px] pr-[20px] duration-300`}>
                        <span className='border border-[#FFFFFF] p-[10px] rounded-full group-hover:bg-white duration-300'>
                            <svg className='w-[15px] h-[15px]' width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* <Link href="/invoices" className={` ${collapsed ? 'gap-[20px]' : 'gap-[10px]'} duration-300 text-white flex items-center whitespace-nowrap group hover:bg-[#C00000] rounded-l-[170px] p-[10px] pr-[20px] duration-300`}>
                        <span className='border border-[#FFFFFF] p-[10px] rounded-full group-hover:bg-white duration-300'>
                            <svg className='w-[15px] h-[15px]' width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link
                        href="/dashboard"
                        className={`
                        ${collapsed ? "gap-[25px]" : "gap-[10px]"}
                            flex items-center whitespace-nowrap
                           rounded-l-[170px] p-[10px] pr-[20px] duration-300 text-white  group
                            ${isActive ? "bg-[#C00000]" : "hover:bg-[#C00000]"}`}>
                        <span
                            className={`border border-white p-[10px] rounded-full duration-300
                            ...
                            <svg
                                ...
                                <path
                                    ...
                                    className={`duration-300 ${isActive ? "fill-secondary" : "fill-white group-hover:fill-secondary"}
        `}
                                />
                            </svg>
                        </span>
    ...
    ${isDriverActive ? "bg-[#C00000]" : "hover:bg-[#C00000]"}
  `}
                    >
                        <span
                            className={`
                        ...
                        >
                            ...
                            >
                                <path
                                    ...
                                    className={`
          duration-300
          ${isDriverActive ? "fill-secondary" : "fill-white group-hover:fill-secondary"}
        `}
                                />
                            </svg>
                        </span>
    ...
    ${isJobActive ? "bg-[#C00000]" : "hover:bg-[#C00000]"}
  `}
                    >
                        <span
                            className={`
                        ...
                        >
                            ...
                            >
                                <path
                                    ...
                                    className={`duration-300 ${isJobActive ? "fill-secondary" : "fill-white group-hover:fill-secondary"}`}
                                />
                                ...
                                <path
                                    d="M1.3514 8.38522C1.49116 8.38522 6.38307 9.27013 6.70889 9.3636V7.68638C6.70889 7.45314 6.89496 7.22078 7.17449 7.22078H9.55056C9.7838 7.22078 10.0162 7.40685 10.0162 7.68638V7.96592V9.3636C10.342 9.31731 15.2339 8.43152 15.3737 8.38522C16.166 8.24546 16.7713 7.54661 16.7713 6.66171V5.26402C16.7713 4.28564 16.0262 3.54051 15.0941 3.54051H12.1127V2.14282C12.1127 0.97838 11.1343 0 9.96987 0H6.80148C5.63704 0 4.65866 0.97838 4.65866 2.14282V3.54051H1.67722C0.745135 3.54051 0 4.33283 0 5.26402V6.66171C0 7.50032 0.559075 8.24546 1.39769 8.38522H1.3514ZM5.54445 2.60842V2.09564C5.54445 1.39679 6.10353 0.884008 6.80237 0.884008H9.97076C10.6696 0.884008 11.2287 1.44308 11.2287 2.09564V3.49332H5.59164V2.56123L5.54445 2.60842Z" v
                                    className={`duration-300 ${isJobActive ? "fill-secondary" : "fill-white group-hover:fill-secondary"}`}
                                />
    ...
    ${isInvoiceActive ? "bg-[#C00000]" : "hover:bg-[#C00000]"}
  `}
                    >
                        <span
                            className={`
                            ...
                            <svg
                                ...
                                <path
                                    ...
                                    className={`duration-300
                                        ${isInvoiceActive ? "fill-secondary" : "fill-white group-hover:fill-secondary"} `}
                                />
    ...
    ${isSettingsActive ? "bg-[#C00000]" : "hover:bg-[#C00000]"}
  `}
                    >
                        <span
                            className={`
                        ...
                        >
                            ...
                            >
                                <path
                                    ...
                                    className={`
          duration-300
          ${isSettingsActive ? "fill-secondary" : "fill-white group-hover:fill-secondary"}
        `}
                                />
                            </svg>
                        </span>
            ...
            <Link
                href=""
                className={`
                border border-[#FFFFFF33] bg-[#FFFFFF0D] rounded-[130px] flex items-center max-w-[159px] m-auto
               text-white duration-300
               ${collapsed ? "p-[10px] mx-[10px] justify-center" : "py-[8px] px-[25px] gap-[10px]"}`}>
                <svg
