...
function Sidebar({ collapsed, setCollapsed }) {
    ...
    return (
        <aside
            className={`${collapsed ? "w-[100px] 2xl:w-[112px]" : "w-[250px] 2xl:w-[374px]"
                } bg-primary h-screen duration-300 overflow-hidden`}
        >
            <div
                className={`${collapsed ? "px-[5px]" : "px-[30px] mx-[10px] 2xl:mx-[15px]"
            ...
            >
                <Image
                    ...
                    width={300}
                    height={300}
                    className={`${collapsed ? "2xl:w-[90px] w-[80px]" : "w-[120px] 2xl:w-[165px]"} duration-300`}
                />
            </div>
            <div
                className={`${collapsed ? "pl-[20px]" : "pl-[20px] 2xl:pl-[55px]"
            ...
            >
                <nav className="space-y-[10px]">
                    <Link
                        ...
                        ${collapsed ? "2xl:gap-[45px] gap-[35px]" : "gap-[10px]"}
                           ...
                           rounded-l-[170px] p-[10px] pr-[20px] duration-300 text-white  group
                            ${isActive ? "bg-[#C00000] font-black" : "hover:bg-[#C00000]"
                            }`}
                    >
                        <span
                    ...
                    <Link
                        ...
                        ${isDriverActive ? "bg-[#C00000] font-black" : "hover:bg-[#C00000]"}
                    `}
                    >
                        <span
                            className={`
                            ...
                            ${isDriverActive ? "bg-white" : "group-hover:bg-white"}
                            `}
                        >
                            <svg
                                className="w-[18px] h-[18px]"
                    ...
                    <Link
                        ...
                        className={`
                            ...
                            ${isJobActive ? "bg-[#C00000] font-black" : "hover:bg-[#C00000]"}
                        `}
                    >
                        <span
                            className={`
                                ...
                                ${isJobActive ? "bg-white" : "group-hover:bg-white"}
                            `}
                        >
                            <svg
                                className="w-[18px] h-[18px]"
                    ...
                    <Link
                        ...
                        ${isInvoiceActive ? "bg-[#C00000] font-black" : "hover:bg-[#C00000]"}
                    `}
                    >
                        <span
                            className={`
                            ...
                            ${isInvoiceActive ? "bg-white" : "group-hover:bg-white"}
                            `}
                        >
                            <svg
                                className="w-[18px] h-[18px]"
                    ...
                    <Link
                        ...
                        ${isSettingsActive ? "bg-[#C00000] font-black" : "hover:bg-[#C00000]"}
                    `}
                    >
                        <span
                            className={`
                            ...
                            ${isSettingsActive ? "bg-white" : "group-hover:bg-white"}
                            `}
                        >
                            <svg
                                className="w-[18px] h-[18px]"
            ...
            <div className="px-[20px]">
                <Link
                   ...
                   <span className={`duration-300 ${collapsed
