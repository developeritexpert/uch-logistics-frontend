...
function Sidebar({ collapsed, setCollapsed }) {
  ...
  return (
    ...
    >
      <div
        className={`${
          collapsed ? "px-[10px]" : "px-[30px]"
        } duration-300 py-[5px] h-[80px] flex items-center justify-center border-b mx-[10px] border-[#FFFFFF33]`}
      >
        <Image
          src="/img/logo.png"
          alt="Logo"
      ...
      <div
        className={`${
          collapsed ? "pl-[10px]" : "pl-[20px]"
        } py-[50px] h-[calc(100vh-180px)] duration-300`}
      >
    ...
    `}
      ...
      <button
        ...
        className={`
               ...
               ${
                 collapsed
                   ? "p-[10px] mx-[10px] justify-center"
                   : "py-[8px] px-[25px] gap-[10px]"
               }`}
      >
        <svg
