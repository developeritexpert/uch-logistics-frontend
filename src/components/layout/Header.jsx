...
function Header({ collapsed, setcollapsed }) {
  return (
    <header className='h-[80px] flex items-center gap-[30px] justify-between px-[30px] py-[20px] bg-white'>
      <div className='flex items-center gap-[20px]'>
        <div
          className='cursor-pointer'
          onClick={() => setcollapsed(!collapsed)}>
          <svg className='w-[20px]' width="25" height="20" viewBox="0 0 25 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className='text-[#223581] text-[20px] md:text-[22px] lg:text-[25px] font-bold'>Dashboard</p>

        <div className='relative ml-[20px] lg:min-w-[400px] md:min-w-[250px]'>
          <input type='text' placeholder='Search Something here...' className='bg-[#F8FAFC] rounded-[170px] w-full py-[10px] pr-[50px] pl-[20px] border border-transparent duration-300 focus-visible:!outline-0 focus-visible:border-[#515151]' />
      ...
      <div>
        <Image src="/img/header-img.png" alt="User" height={50} width={50} className='rounded-full w-[50px]'/>       
      </div>
    </header>
  )
}
