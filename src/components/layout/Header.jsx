...
function Header({ collapsed, setcollapsed }) {
  return (
    <header className='h-[80px] flex items-center gap-[30px] justify-between px-[30px] py-[20px] '>
      <div className='flex items-center gap-[20px]'>
        ...
        <p className='text-[#223581] text-[24px] md:text-[28px] lg:text-[34px] font-bold'>Dashboard</p>

        <div className='relative'>
          <input type='text' placeholder='Search Something here...' className='bg-[#F8FAFC] rounded-[170px] w-full py-[10px] pr-[50px] pl-[20px] focus-visible:!outline-0' />
      ...
      <div className=' w-[40px] h-[40px]  lg:w-[60px] lg:h-[60px] rounded-[50%]'>
